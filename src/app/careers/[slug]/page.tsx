...
export async function generateMetadata({ params }: Props) {
  ...
  if (!job) {
    return {
      title: 'Job Not Found | Gurkha Health & Services',
    };
  }

  return {
    title: `${job.title} | Careers - Gurkha Health & Services`,
    description: `${job.title} position at Gurkha Health & Services in ${job.location}`,
  };
}
          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="bg-gradient-to-br from-rose-50 via-brand-50 to-red-50 dark:from-slate-800/50 dark:via-slate-800/60 dark:to-slate-700/60 rounded-xl p-8 border border-brand-500/30 dark:border-slate-600 backdrop-blur-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {isOpen && (
                  <a
                    href={`mailto:info@gurkhahealth.co.uk?subject=${encodeURIComponent(
